...
public class Fault extends JFrame implements ActionListener {
	...
	JLabel lb_head;
	ImageIcon bang = new ImageIcon(getClass().getResource("/iconSuccess/img_logindefault_decorate.png"));
	JLabel lb_bang;
	Container c;
	
	public Fault () {
		btn_close = new JButton(new ImageIcon(getClass().getResource("/iconSuccess/bg_logindefault_close_button.png")));
		lb_imformation = new JLabel("文件加密失败");
...
//new ImageIcon(getClass().getResource("/iconforadmin/img_fresh_btn.png"))

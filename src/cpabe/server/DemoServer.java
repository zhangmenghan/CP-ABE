...
public class DemoServer {
	// public static final String FILEDIRPATH = "D:/serverfiles/";
//	public static final String FILEDIRPATH = System.getProperty("user.dir")
//			+ "/../ServerFiles/";
	...
	/**
	 * @see "mskfile" is the path for your master key file.
	 * */
	static String mskfile = "./file_dir/master_key";

	/**
	 * @see "prvfile" presents the path for you private key file
	 * */
	// public static String prvfile = "F:/QQPCmgr/Desktop/prv_file_dir/prv_key";
//	public static String prvfileDir = System.getProperty("user.home")
//			+ "/prvDir/";
	public static String prvfileDir = null;
	static String inputfile = "file_dir/input.pdf";
	static String encfile = "file_dir2/input.pdf.cpabe";
	static String decfile = "file_dir2/input.pdf";
	...
	// static String authority_attr =
	// "boss:boss generalman:generalman commongener:generalman cfo:cfo test:test cto:cto planner:planner artisan:artisan "
	// +
	// "dustman:dustman salesman:salesman testcontroller:testcontroller hr:hr";

	static String authority_attr = "boss:boss";
	...
	public static void setup() throws Exception {
		...
		File pub = new File(DemoServer.pubfile);
		if(!pub.exists()){
			pub.createNewFile();
		}
		
		File msk = new File(DemoServer.pubfile);
		if(!msk.exists()){
			msk.createNewFile();
		}
	...
	public static void keygen(String attr_str) throws Exception {
		// String attr_str = authority_attr;

		File dir = new File(DemoServer.prvfileDir);
		if (!dir.exists()) {
			dir.mkdirs();
		}
		String prvfile = DemoServer.prvfileDir + "prv_key";
		Cpabe abe = new Cpabe();

		abe.keygen(pubfile, prvfile, mskfile, attr_str);
	}

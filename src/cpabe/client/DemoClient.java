...
public class DemoClient {
	...
	public static String pubfile = "./file_dir/pub_key";
//	public static String pubfile = "./fileTemp/pub_key";
	public static String prvfile = null;
	public final static String ServerRootDir = "./Root/";

	// public static String inputfile = null;
	// public static String encfile = null;
	// public static String decfile = null;

	/**
	 * store those ciphertexts which have been downloaded from server.
	 * */
//	public static String clientCiphertextDir = System.getProperty("user.dir")+"/../ClientCiphertextDir/";
	public static String clientCiphertextDir = null;
//	public static String serverCiphertextDir = System.getProperty("user.dir")+"/../ServerCiphertextDir/";
	public static String serverCiphertextDir = null;
	public static String storeCiphertextPath = null;
	public static String encfile = null;

	/**
	 * store those files which have been decrypted--
	 * */
//	public static String storeHasDecFileDir = System.getProperty("user.dir")+"/../PlaintextDir/";
	public static String storeHasDecFileDir = null;

	public static String attributePropertiesFilePath = "./fileTemp/attribute.properties";
	public static String policyPropertiesFilePath = "./fileTemp/policy.properties";
	public static String policyContent = null;
	...
	// "student teacher professor 2of3 master police 2of3 boss 1of2";
	...
	/**
	 * @see "pubfile" is your public file
	 * @see inputfile respent that the file need to be encrypt,contains
	 *      directory name and file name;
	 * @see encfile respent that the filepathname containing directory and
	 *      clientFileName that store those ciphertexts after encrypting,
	 *      the filepathname goes like this:"directory+"/"+clientFileName";
	 * @see policy--> access policy,The policy of "policy" is like follows,
	 *      "Tom mouse 2of2 doctor_degree vice_monitor 2of3 cat 1of2" means one
	 *      must keeps attribute that (at least 2 in ((Tom and mouse),
	 *      doctore_degree,vice_monitor)) or cat can decrypt the file.
	 * */
	public static void encryptFile(String inputfile, String encfile,
			String policy) throws Exception {
		Cpabe abe = new Cpabe();
		abe.enc(pubfile, policy, inputfile, encfile);
	}

	/**
	 * @see encfile respent that the ciphertext file name containing directory
	 *      name after encrypting
	 * @see decfile repsent that the plaintext file name containing directory
	 *      name after decrypting.
	 * */
	public static void decryptCiphertext(String prvfile, String encfile,
			String decfile) throws Exception {
		Cpabe abe = new Cpabe();
		abe.dec(pubfile, prvfile, encfile, decfile);
	}
...
//		 */
//		// DemoClient.encryptFile("cto:cto cfo:cfo 1of2 boss:boss generalman:generalman 1of3");
//		// DemoClient.decryptCiphertext();
//	}
}
